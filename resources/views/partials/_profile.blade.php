    ...
    <div class="profile-sidebar thumbnail">
		...
		<div class="">
			...
			<span class="text-center">
				<button class="site-btn" type="button" title="Edit Profile" data-toggle="modal" data-target="#editProfileModal" data-backdrop="static"><i class="fa fa-edit"></i> Edit Profile</button>
			</span>
		</div>
		<!-- END MENU -->
	</div>
