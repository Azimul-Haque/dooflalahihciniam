              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="checkout__order">
                        ...
                        <div class="checkout__order__subtotal">Delivery Charge <label>¥</label><span id="deliveryCharge">{{ $cart->deliveryCharge }}</span></div>
                        <div class="checkout__order__total">Subtotal <span>$750.99</span></div>
