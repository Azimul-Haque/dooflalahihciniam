      ...
      <div class="container">
          ...
          <div class="row featured__filter">
            @foreach($featureditems as $featureditem)
              <div class="col-lg-3 col-md-4 col-sm-6 mix @if($featureditem->category->id == 1) beef @elseif($featureditem->category->id == 2) chicken @elseif($featureditem->category->id == 2) @endif">
