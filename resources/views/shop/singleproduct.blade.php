                                      ...
                                      <div class="col-md-6 col-sm-12">
                                          <div class="blog-comment-form">
                                              ...
                                              {!! Form::open(['route' => 'product.storeproductreview', 'method' => 'POST']) !!}
                                                  ...
                                                  <select class="form-control nice-select" name="rating" required="" style="width: 100%; font-size: 16px; padding-left: 20px; color: #1c1c1c; height: 46px; border: 1px solid #ededed;">
