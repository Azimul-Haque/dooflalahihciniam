                  ...
                  <div class="product__details__text">
                      ...
                      <div class="product__details__rating">
                          ...
                          @php
                              ...
                              $cslug = \Illuminate\Support\Str::slug(preg_replace('/[^\w\d]+/', '-', $ctext));
                          @endphp
                          <a class="badge badge-pill badge-warning" href="{{ route('product.categorywise', [$product->category->id, $cslug]) }}" style="font-size: 14px;">{{ $product->category->name }}</a>
                      </div>
                      ...
                      <div class="product__details__quantity">
                          <div class="quantity">
                              <div class="pro-qty">
                                  <input type="text" id="productQty" max="{{ $product->stock }}" min="1" value="1">
                              </div>
                          </div>
                      </div>
                      <a href="javascript:void(0)" class="primary-btn" id="addToCartSingle">ADD TO CARD</a>
                      @if(Auth::check())
                      ...
                      <ul>
                          ...
                          <li><b>Weight</b> <span>{{ $product->shorttext }}</span></li>
                          <li><b>Share on</b>
                              <div class="share">
