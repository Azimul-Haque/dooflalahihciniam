        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <div class="card card-success shadow-light">
              ...
              <div class="card-body">
                <h4>
                  <a href="{{ route('warehouse.receiptpdf', [$orders->first()->payment_id, generate_token(100)]) }}" class="site-btn pull-right" title="Print Invoice" target="_blank"><i class="fa fa-print" aria-hidden="true"></i></a>
            ...
            <center>
              <h2>
                No order found<br/>
                <a class="site-btn" href="{{ route('product.index') }}"><i class="fa fa-shopping-bag"></i> See Products</a>
              </h2>
            </center>
            @endif
            <br/>
