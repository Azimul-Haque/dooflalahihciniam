        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <div class="card panel-success shadow-light">
              ...
              <div class="card-body">
                <h4>
                  <a href="{{ route('warehouse.receiptpdf', [$orders->first()->payment_id, generate_token(100)]) }}" class="" title="Print Invoice" target="_blank"><i class="fa fa-print" aria-hidden="true"></i></a>
